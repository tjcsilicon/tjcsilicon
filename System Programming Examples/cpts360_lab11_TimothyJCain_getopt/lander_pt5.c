...
int main(int argc, char *argv[])
{
    ...
    static struct option options[] = {
        ...
        {"initial-fuel", required_argument, NULL, 'f'},
        {"initial-height", required_argument, NULL, 'h'},
        {"initial-velocity", required_argument, NULL, 'v'},
        {"max-thrust", required_argument, NULL, 't'},
        {NULL, 0, NULL, 0}   
    };
    int optionIndex = 0;
    while ((optionLetter = getopt_long(argc, argv, "t:f:g:h:v:", options, &optionIndex)) != -1) 
    {
        switch (optionLetter) 
        {
            case 't':
